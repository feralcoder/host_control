...
if [[ "$VM_NAME" == "" ]]; then
  ...
  WEB_HOOK=https://eac23562-bfe2-485a-a3c8-75781b177934.webhook.eus.azure-automation.net/webhooks?token=iKkAsSKDb%2frfjZHio%2b35iYgPa%2bfHZ4P1eAY2vyFofdc%3d
elif [[ "$VM_NAME" == q ]]; then
  WEB_HOOK=https://eac23562-bfe2-485a-a3c8-75781b177934.webhook.eus.azure-automation.net/webhooks?token=RjQu6CSlcf8%2fmIOvI6rniRd3nXf4e29EFqvO7Gnqh08%3d
else
...
for TRY in $(seq 1 $TRIES); do
  ...
  ssh -o ConnectTimeout=3 $VM_NAME.feralcoder.org hostname && {
    ssh -o ConnectTimeout=3 $VM_NAME.feralcoder.org touch $SHUTDOWN_LOCK
    echo $VM_NAME HAS BEEN SUMMONED
    return
  }
