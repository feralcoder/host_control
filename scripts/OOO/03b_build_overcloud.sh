...
ssh_control_run_as_user root "rm /root/overcloud_install*; tmux new-session -d -s overcloud '$OVERCLOUD_BUILD_OPTIONS /home/cliff/CODE/feralcoder/train8/setup_overcloud.sh > overcloud_install_\$\$.log'; sleep 5; tmux split-window -t overcloud -h 'tail -f /root/overcloud_install_*'" dmb
